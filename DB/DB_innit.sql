...
DROP INDEX IF EXISTS BI_KYLUAT2_FK ON BI_KYLUAT;
DROP INDEX IF EXISTS BI_KYLUAT_FK ON BI_KYLUAT;
...
DROP INDEX IF EXISTS CO_CAPLYLUANCHINHTRI2_FK ON CO_CAPLYLUANCHINHTRI;
DROP INDEX IF EXISTS CO_CAPLYLUANCHINHTRI_FK ON CO_CAPLYLUANCHINHTRI;
DROP TABLE IF EXISTS CO_CAPLYLUANCHINHTRI;

DROP INDEX IF EXISTS CO_CAPQUANLYNHANUOC2_FK ON CO_CAPQUANLYNHANUOC;
DROP INDEX IF EXISTS CO_CAPQUANLYNHANUOC_FK ON CO_CAPQUANLYNHANUOC;
DROP TABLE IF EXISTS CO_CAPQUANLYNHANUOC;

DROP INDEX IF EXISTS CO_CHUCVU4_FK ON CO_CHUCVU;
DROP INDEX IF EXISTS CO_CHUCVU3_FK ON CO_CHUCVU;
DROP INDEX IF EXISTS CO_CHUCVU2_FK ON CO_CHUCVU;
DROP INDEX IF EXISTS CO_CHUCVU_FK ON CO_CHUCVU;
DROP TABLE IF EXISTS CO_CHUCVU;

DROP INDEX IF EXISTS CO_HESOLUONG3_FK ON CO_HESOLUONG;
DROP INDEX IF EXISTS CO_HESOLUONG2_FK ON CO_HESOLUONG;
DROP INDEX IF EXISTS CO_HESOLUONG_FK ON CO_HESOLUONG;
DROP TABLE IF EXISTS CO_HESOLUONG;

DROP INDEX IF EXISTS CO_HOKHAUTHUONGTRU2_FK ON CO_HOKHAUTHUONGTRU;
DROP INDEX IF EXISTS CO_HOKHAUTHUONGTRU_FK ON CO_HOKHAUTHUONGTRU;
DROP TABLE IF EXISTS CO_HOKHAUTHUONGTRU;

DROP INDEX IF EXISTS CO_TAMTRU2_FK ON CO_TAMTRU;
DROP INDEX IF EXISTS CO_TAMTRU_FK ON CO_TAMTRU;
DROP TABLE IF EXISTS CO_TAMTRU;

DROP INDEX IF EXISTS CO_TINHTRANGSK2_FK ON CO_TINHTRANGSK;
DROP INDEX IF EXISTS CO_TINHTRANGSK_FK ON CO_TINHTRANGSK;
DROP TABLE IF EXISTS CO_TINHTRANGSK;

DROP INDEX IF EXISTS CO_TRINHDOCHUYENMONCAONHAT_FK ON CO_TRDCM_CAONHAT;
DROP TABLE IF EXISTS CO_TRDCM_CAONHAT;

DROP INDEX IF EXISTS CO_TRINHDONGOAINGU_FK ON CO_TRD_NGOAINGU;
DROP TABLE IF EXISTS CO_TRD_NGOAINGU;

DROP INDEX IF EXISTS CO_TRINHDOTINHOC_FK ON CO_TRD_TINHOC;
DROP TABLE IF EXISTS CO_TRD_TINHOC;

DROP TABLE IF EXISTS DANHHIEU;
DROP TABLE IF EXISTS DANTOC;

DROP INDEX IF EXISTS DUOC_KHENTHUONG2_FK ON DUOC_KHENTHUONG;
DROP INDEX IF EXISTS DUOC_KHENTHUONG_FK ON DUOC_KHENTHUONG;
...
DROP INDEX IF EXISTS THUOC_NHOM_NGACH2_FK ON THUOC_NHOM_NGACH;
DROP INDEX IF EXISTS THUOC_NHOM_NGACH_FK ON THUOC_NHOM_NGACH;
DROP TABLE IF EXISTS THUOC_NHOM_NGACH;

DROP INDEX IF EXISTS THUOC_QUANDOI3_FK ON THUOC_QUANDOI;
DROP INDEX IF EXISTS THUOC_QUANDOI2_FK ON THUOC_QUANDOI;
DROP INDEX IF EXISTS THUOC_QUANDOI_FK ON THUOC_QUANDOI;
DROP TABLE IF EXISTS THUOC_QUANDOI;

DROP INDEX IF EXISTS THUOC_TOCHUCDOANTHECHINHTRIXAHOI2_FK ON THUOC_TOCHUCDOANTHECHINHTRIXAHOI;
DROP INDEX IF EXISTS THUOC_TOCHUCDOANTHECHINHTRIXAHOI_FK ON THUOC_TOCHUCDOANTHECHINHTRIXAHOI;
...
DROP INDEX IF EXISTS TUYENDUNG3_FK ON TUYENDUNG;
DROP INDEX IF EXISTS TUYENDUNG2_FK ON TUYENDUNG;
DROP INDEX IF EXISTS TUYENDUNG_FK ON TUYENDUNG;
DROP TABLE IF EXISTS TUYENDUNG;

DROP INDEX IF EXISTS CO_HANGTHUONGBINH_FK ON VIENCHUC;
DROP INDEX IF EXISTS DUOCPHONG_DANHHIEU_FK ON VIENCHUC;
DROP INDEX IF EXISTS DUOCPHONG_HOCHAM_FK ON VIENCHUC;
DROP INDEX IF EXISTS CO_QUEQUAN_FK ON VIENCHUC;
DROP INDEX IF EXISTS CO_NOISINH_FK ON VIENCHUC;
DROP INDEX IF EXISTS CO_TONGIAO_FK ON VIENCHUC;
DROP INDEX IF EXISTS VIENCHUC_CO_DANTOC_FK ON VIENCHUC;
DROP INDEX IF EXISTS CO_TRINHDOHOCVAN_FK ON VIENCHUC;
DROP TABLE IF EXISTS VIENCHUC;

DROP INDEX IF EXISTS TRUCTHUOC_FK ON XAPHUONG;
